...
def teleconsulatationGetAppointment_Byid(id):
    try:
        URL = 'https://staging-api.vivifyhealthcare.com/UserAppointment/GetAppointmentByUserIdAppointmenttype/{}/teleconsulatation'.format(id)
